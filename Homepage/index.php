			...
			<!-- Header -->
				<div id="header-wrapper" class="wrapper">
					<div id="header">
						...
						<!-- Logo -->
							<div id="logo">
								<a href="Pencapaian.php" action="Pencapaian.php" >Hai <?php echo $_POST["username"]; ?>
								</a>
								...
								<!-- Registration Form -->
									...
									<div class="4u 12u(mobile)">
										<section class="highlight">
											...
											<div class="row">
													<input type="text" name="Username" id="contact-name" placeholder="Nama" />
											</div>
											<div class="row">
													<ul class="actions">
														<li><input type="submit" name="register.btn" class="style1" value="-------Daftar--------" /></li>
													</ul>
											</div>
										</form>
										</section>
